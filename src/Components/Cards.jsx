...
function Cards() {
    ...
    // Pagination
  useEffect(()=>{
    const newLastIndex = startIndex + perPage 
    setCurrentItem(data.slice(startIndex,newLastIndex))
...
//   function 
 function handlePage (item){
     const newIndex = (item.selected * perPage) % data.length
                ...
                <div className='text-center justify-center w-100 flex gap-10 flex-wrap'>
                    ...
                    {currentItem.map((item,index)=>{
                        ...
                        <div className="px-5 pb-5">
                            <a href="#">
                                <h5 className="text-base font-semibold tracking-tight text-gray-900 dark:text-white">abc</h5>
                            </a>
                            ...
                            <div className="flex items-center justify-between">
                                <span className="text-xl font-bold text-gray-900 dark:text-white">1000$</span>
                                <a href="#" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add to cart</a>
                            </div>
                        </div>
                    </div>
                         )
  ...
  <div className='text-center flex justify-center Page navigation example '>
            <ReactPaginate
                breakLabel="..."
                nextLabel="next >"
                ...
                containerClassName='text-white inline-flex -space-x-px'
                ...
                activeClassName='bg-blue-900 text-gray-700'
            />
            </div>
